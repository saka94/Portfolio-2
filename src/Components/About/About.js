  ...
  return (
    <main>
      <div className="container my-5">
        <div className="row container__about">
          <div className="col">
            <img className="card-img-top" src={pictureOne} alt="The owner of the website" />
            <p>
          ...
          <div className="col reverse">
            ...
            <img className="card-img-top" src={pictureTwo} alt="A computer" />
          </div>
        </div>
      </div>
    </main>
